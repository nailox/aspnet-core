    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAbpIdentity<Tenant, User, Role, SecurityStampValidator>(options =>
                {
                    options.Cookies.ApplicationCookie.AuthenticationScheme = "BookStoreAuthSchema";
                    options.Cookies.ApplicationCookie.CookieName = "BookStoreAuth";
                })
            ...
            return services.AddAbp<BookStoreWebHostModule>(options =>
            {
